          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex items-center gap-2 flex-1 min-w-0">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white truncate flex-1" title={monitor.channelTitle || monitor.channel}>
                ...
                {monitor.channelTitle && (
                  <div className="group relative flex-shrink-0">
                    ...
                    <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50">
